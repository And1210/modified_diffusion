from denoising_diffusion_pytorch.segmaskindiv_brightness_denoising_diffusion_pytorch import GaussianDiffusion, Unet, Trainer
...
trainer = Trainer(
    ...
    results_folder = "./results_segmaskindiv_brightness",
    seg_choice = 10
)
