from denoising_diffusion_pytorch.ped_loc_fourier_denoising_diffusion_pytorch import Unet, GaussianDiffusion, Trainer
import os
import numpy as np
...
trainer = Trainer(
    ...
    results_folder = 'results_ped_loc_fourier'
)

PATH = './generate_ped_loc_fourier'
trainer.load('', True)
