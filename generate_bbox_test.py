from denoising_diffusion_pytorch.bbox_test_denoising_diffusion_pytorch import Unet, GaussianDiffusion, Trainer
import os
...
PATH = '/ingenuity_NAS/16amf8_nas/16amf8_mount/data/datasets/CP_Seg_Gen_bbox_test/train_seg'
trainer.load('', True)
trainer.generate(10, PATH)
